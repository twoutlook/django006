...
class Item003(models.Model):
    ...
    field1a = models.CharField(default=".",max_length=200,verbose_name="噸位")
    # 結構
    field2a1 = models.CharField(default=".", max_length=200,verbose_name="格林柱")
    field2a2 = models.CharField(default=".", max_length=200,verbose_name="機架底座")
    field2a3 = models.CharField(default=".", max_length=200,verbose_name="模板")
    field2a4 = models.CharField(default=".", max_length=200,verbose_name="合模")
    field2a5 = models.CharField(default=".", max_length=200,verbose_name="間隙")
    field2a6 = models.CharField(default=".", max_length=200,verbose_name="膜厚調節")
    #液壓油
    field2b1 = models.CharField(default=".", max_length=200,verbose_name="油管")
    field2b2=  models.CharField(default=".", max_length=200,verbose_name="過濾")
    field2b3 = models.CharField(default=".", max_length=200,verbose_name="油箱")
    field2b4 = models.CharField(default=".", max_length=200,verbose_name="馬達")
    
    field2c1 = models.CharField(default=".", max_length=200,verbose_name="潤滑")
    field2d1 = models.CharField(default=".", max_length=200,verbose_name="氮氣")
    field2e1 = models.CharField(default=".", max_length=200,verbose_name="電控")
    field2f1 = models.CharField(default=".", max_length=200,verbose_name="自動噴霧")
    field2g1 = models.CharField(default=".", max_length=200,verbose_name="自動取出")
    field2h1 = models.CharField(default=".", max_length=200,verbose_name="自動切邊去毛")
    
    
    
    field3 = models.CharField(default=".", max_length=200,verbose_name="零件")
    field4a = models.CharField(default=".", max_length=200,verbose_name="進度一")
    field4b = models.CharField(default=".", max_length=200,verbose_name="進度二")
    field4c = models.CharField(default=".", max_length=200,verbose_name="進度三")
    def __str__(self):
        return self.field1        
# class Item003(models.Model):
#     field1 = models.CharField(max_length=200)
